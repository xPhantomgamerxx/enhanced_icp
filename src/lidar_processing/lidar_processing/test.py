...
def test_pipeline():
    ...
    timestep_2 = "0000000002"  # Second timestep
    ...
    # Run ICP
    print("Running ICP...")
    predicted_transform, _, _ = icp(enriched_t1[:, :3], enriched_t2[:, :3], init_pose=np.eye(4), max_iterations=100, tolerance=0.001, use_semantic_features=False, simple=False)
    ...
    visualize_icp_results(points_t1[:, :3], points_t2[:, :3], gt_translation_points)
